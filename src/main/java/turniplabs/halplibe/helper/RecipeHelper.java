...
public class RecipeHelper {
    ...
    public static class Crafting {
        ...
        public static void removeRecipe(Block outputBlock, int meta) {
            ...
            for (Object recipe : recipes) {
                if (recipe instanceof RecipeShaped && ((RecipeShaped) recipe).recipeOutput.itemID == outputBlock.blockID && ((RecipeShaped) recipe).recipeOutput.getMetadata() == meta) {
                    theRecipe = (IRecipe) recipe;
                    break;
                } else if (recipe instanceof RecipeShapeless && ((RecipeShapeless) recipe).recipeOutput.itemID == outputBlock.blockID && ((RecipeShapeless) recipe).recipeOutput.getMetadata() == meta) {
                    theRecipe = (IRecipe) recipe;
                    break;
                }
            }
            ...
            if (theRecipe == null) {
                HalpLibe.LOGGER.debug("Couldn't find crafting recipe with output: " + outputBlock.getBlockName(meta));
                return;
            }
        ...
        public static void removeRecipe(Item outputItem, int meta) {
            ...
            for (Object recipe : recipes) {
                if (recipe instanceof RecipeShaped && ((RecipeShaped) recipe).recipeOutput.itemID == outputItem.itemID && ((RecipeShaped) recipe).recipeOutput.getMetadata() == meta) {
                    theRecipe = (IRecipe) recipe;
                    break;
                } else if (recipe instanceof RecipeShapeless && ((RecipeShapeless) recipe).recipeOutput.itemID == outputItem.itemID && ((RecipeShapeless) recipe).recipeOutput.getMetadata() == meta) {
                    theRecipe = (IRecipe) recipe;
                    break;
                }
            }
            ...
            if (theRecipe == null) {
                HalpLibe.LOGGER.debug("Couldn't find crafting recipe with output: " + outputItem.getItemName());
                return;
            }
